...
acc_r = df_squared["acc_x"] ** 2 + df_squared["acc_x"] ** 2 + df_squared["acc_z"] ** 2
gyr_r = df_squared["gyr_x"] ** 2 + df_squared["gyr_x"] ** 2 + df_squared["gyr_z"] ** 2
...
df_squared = df_squared.drop("duration", axis=1)
...
df_freq = FreqAbs.abstract_frequency(df_freq, ["acc_y"], ws, fc)
...
for s in df_freq["set"].unique():
    ...
    subset = FreqAbs.abstract_frequency(subset, predictor_columns, ws, fc)
